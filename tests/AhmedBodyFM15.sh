...
# === Optional: potentialFoam initialisation === 
echo "🔹 Initialising fields with potentialFoam..."

# Step 1: backup original 0/p
cp 0/p 0/p.backup

# Step 2: run with -writePhi and -writep
run_step "Running potentialFoam" "potentialFoam -writePhi -writep" "${LOG_DIR}/potentialFoam.log"

# Step 3: restore original physical p
cp 0/p.backup 0/p
