...
CASE_NAME="unitCubecoarse"  #remember to adjust this for each different case
...
singularity exec ../../../containers/container.sif python3 ../../../src/scripts/postProcessing/plottingForces.py --configDir $CONFIG_DIR || {
  echo "❌ Python script plottingForces.py failed"
  exit 1
}

singularity exec ../../../containers/container.sif python3 ../../../src/scripts/postProcessing/plottingCont.py --configDir $CONFIG_DIR || {
  echo "❌ Python script plottingCont.py failed"
  exit 1
}

singularity exec ../../../containers/container.sif python3 ../../../src/scripts/postProcessing/plottingResiduals.py --configDir $CONFIG_DIR || {
  echo "❌ Python script plottingResiduals.py failed"
  exit 1
}

singularity exec ../../../containers/container.sif python3 ../../../src/scripts/postProcessing/plottingyPlus.py --configDir $CONFIG_DIR || {
  echo "❌ Python script plottingyPlus.py failed"
  exit 1
}
