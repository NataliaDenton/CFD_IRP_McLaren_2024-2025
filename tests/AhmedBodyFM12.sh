...
run_step "Renumbering mesh for solver optimisation" "renumberMesh -overwrite" "${LOG_DIR}/renumberMesh.log"
...
# === Solver Execution ===
run_step "Checking mesh quality (full)" "checkMesh -allGeometry -allTopology -constant" "${LOG_DIR}/checkMesh.log"
