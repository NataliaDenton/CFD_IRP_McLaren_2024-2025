...
all_points = []
stl_points = IO_fcts.load_geometry(geometry_config["file"])
...
blockMesh_content = populator_module.generate_blockMeshDict(vertices, cell_counts)
...
feature_dict = populator_module.generate_surfaceFeatureExtractDict(geometry_config["file"], extract_angle)
